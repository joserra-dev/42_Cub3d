...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2025/03/16 12:08:24 by joscastr          #+#    #+#              #
#    Updated: 2025/03/16 12:08:25 by joscastr         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ifeq ($(UNAME), Linux)
	...
	LMLX = -Lminilibx-linux -lmlx -lXext -lX11 -lm -lbsd
	OS_X =
	END = end_linux.c
	CDEBUG = #-g3
endif
...
$(NAME): $(LIBFT) $(OBJ) $(OBJ_GNL) | $(BIN_DIR)
	...
	@$(CC) $(CFLAGS) $(CDEBUG) $(OBJ) $(OBJ_GNL) $(LIBFT) -Lminilibx-linux -lmlx -lXext -lX11 -lm -lbsd -o $@
...
$(LIBFT_DIR):
	@git clone https://github.com/(path de libft)

$(GNL_DIR):
	@git clone https://github.com/(path de get_next_line)
